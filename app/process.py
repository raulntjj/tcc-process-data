...
try:
    df = pd.read_csv('./input/teste.csv')
...
rename_map_prof = {
    ...
    '1.6 - Você também leciona em outra(s) escola(s) além da E.E. Doutor José Augusto?\xa0 Se sim,\xa0qual é o principal método de gestão acadêmica utilizado?': 'P1.6_Outra_Escola_Metodo',
    ...
    '2.2 - Acessar os registros fora do ambiente escolar era uma tarefa simples.\xa0 \xa0[Manual]': 'P2.2_Acesso_Fora_Manual',
    '2.2 - Acessar os registros fora do ambiente escolar era uma tarefa simples.\xa0 \xa0[Planilha]': 'P2.2_Acesso_Fora_Planilha',
    '2.2 - Acessar os registros fora do ambiente escolar era uma tarefa simples.\xa0 \xa0[PlanningApp]': 'P2.2_Acesso_Fora_PlanningApp',
    '2.3 - Era fácil encontrar informações de planejamentos passados.\xa0 \xa0[Manual]': 'P2.3_Encontrar_Info_Manual',
    '2.3 - Era fácil encontrar informações de planejamentos passados.\xa0 \xa0[Planilha]': 'P2.3_Encontrar_Info_Planilha',
    '2.3 - Era fácil encontrar informações de planejamentos passados.\xa0 \xa0[PlanningApp]': 'P2.3_Encontrar_Info_PlanningApp',
    '2.4 - A necessidade de retrabalho (corrigir erros, refazer lançamentos) era baixa.\xa0 \xa0[Manual]': 'P2.4_Retrabalho_Manual',
    '2.4 - A necessidade de retrabalho (corrigir erros, refazer lançamentos) era baixa.\xa0 \xa0[Planilha]': 'P2.4_Retrabalho_Planilha',
    '2.4 - A necessidade de retrabalho (corrigir erros, refazer lançamentos) era baixa.\xa0 \xa0[PlanningApp]': 'P2.4_Retrabalho_PlanningApp',
    '2.5 - O tempo total gasto com tarefas administrativas era razoável.\xa0 \xa0[Manual]': 'P2.5_Tempo_Admin_Manual',
    '2.5 - O tempo total gasto com tarefas administrativas era razoável.\xa0 \xa0[Planilha]': 'P2.5_Tempo_Admin_Planilha',
    '2.5 - O tempo total gasto com tarefas administrativas era razoável.\xa0 \xa0[PlanningApp]': 'P2.5_Tempo_Admin_PlanningApp',
    ...
    '3.1 - O método era fácil de aprender e usar.\xa0 \xa0[Manual]': 'P3.1_Facil_Aprender_Manual',
    '3.1 - O método era fácil de aprender e usar.\xa0 \xa0[Planilha]': 'P3.1_Facil_Aprender_Planilha',
    '3.1 - O método era fácil de aprender e usar.\xa0 \xa0[PlanningApp]': 'P3.1_Facil_Aprender_PlanningApp',
    '3.2 - As informações estavam organizadas de forma clara e intuitiva.\xa0 \xa0[Manual]': 'P3.2_Org_Clara_Manual',
    '3.2 - As informações estavam organizadas de forma clara e intuitiva.\xa0 \xa0[Planilha]': 'P3.2_Org_Clara_Planilha',
    '3.2 - As informações estavam organizadas de forma clara e intuitiva.\xa0 \xa0[PlanningApp]': 'P3.2_Org_Clara_PlanningApp',
    ...
    '4.4 - A comunicação com a coordenação pedagógica era eficiente.\xa0 \xa0[Manual]': 'P4.4_Comun_Coord_Manual',
    '4.4 - A comunicação com a coordenação pedagógica era eficiente.\xa0 \xa0[Planilha]': 'P4.4_Comun_Coord_Planilha',
    '4.4 - A comunicação com a coordenação pedagógica era eficiente.\xa0 \xa0[PlanningApp]': 'P4.4_Comun_Coord_PlanningApp',
    # Section 5: Bem-Estar
    '5.1 - O método contribuía para reduzir meu nível de estresse com tarefas burocráticas.\xa0 \xa0[Manual]': 'P5.1_Reduz_Estresse_Manual',
    '5.1 - O método contribuía para reduzir meu nível de estresse com tarefas burocráticas.\xa0 \xa0[Planilha]': 'P5.1_Reduz_Estresse_Planilha',
    '5.1 - O método contribuía para reduzir meu nível de estresse com tarefas burocráticas.\xa0 \xa0[PlanningApp]': 'P5.1_Reduz_Estresse_PlanningApp',
    '5.2 - O uso da ferramenta frequentemente me causava frustração (tecnoestresse).\xa0 \xa0[Manual]': 'P5.2_Causa_Frustracao_Manual',
    '5.2 - O uso da ferramenta frequentemente me causava frustração (tecnoestresse).\xa0 \xa0[Planilha]': 'P5.2_Causa_Frustracao_Planilha',
    '5.2 - O uso da ferramenta frequentemente me causava frustração (tecnoestresse).\xa0 \xa0[PlanningApp]': 'P5.2_Causa_Frustracao_PlanningApp',
    '5.3 - Eu sentia que tinha controle e autonomia sobre meus planejamentos.\xa0 \xa0[Manual]': 'P5.3_Controle_Autonomia_Manual',
    '5.3 - Eu sentia que tinha controle e autonomia sobre meus planejamentos.\xa0 \xa0[Planilha]': 'P5.3_Controle_Autonomia_Planilha',
    '5.3 - Eu sentia que tinha controle e autonomia sobre meus planejamentos.\xa0 \xa0[PlanningApp]': 'P5.3_Controle_Autonomia_PlanningApp',
    '5.4 - O método passava uma imagem de maior profissionalismo e organização do meu trabalho.\xa0 \xa0[Manual]': 'P5.4_Profissionalismo_Manual',
    '5.4 - O método passava uma imagem de maior profissionalismo e organização do meu trabalho.\xa0 \xa0[Planilha]': 'P5.4_Profissionalismo_Planilha',
    '5.4 - O método passava uma imagem de maior profissionalismo e organização do meu trabalho.\xa0 \xa0[PlanningApp]': 'P5.4_Profissionalismo_PlanningApp',
    '5.5 - O método liberava meu tempo para focar em atividades mais estratégicas.\xa0 \xa0[Manual]': 'P5.5_Libera_Tempo_Manual',
    '5.5 - O método liberava meu tempo para focar em atividades mais estratégicas.\xa0 \xa0[Planilha]': 'P5.5_Libera_Tempo_Planilha',
    '5.5 - O método liberava meu tempo para focar em atividades mais estratégicas.\xa0 \xa0[PlanningApp]': 'P5.5_Libera_Tempo_PlanningApp',
    # Section 6: Abertas
    '6.1 - Por favor, descreva uma situação ou tarefa específica que o novo Sistema de Planejamento tornou muito mais simples de realizar em comparação com os métodos anteriores.\xa0 ': 'P6.1_Situacao_Simples',
    '6.2 - Pensando no impacto final do nosso trabalho, você acredita que a organização proporcionada pelo Sistema de Planejamento pode, de alguma forma, beneficiar os alunos indiretamente? Se sim, como?\xa0 ': 'P6.2_Beneficio_Alunos',
    ...
    '6.7 - Pensando nas funcionalidades pedagógicas (criação de planejamentos, gestão de turmas etc.), quais foram os principais benefícios ou desafios encontrados no novo\xa0 sistema de planejamento?': 'P6.7_Beneficios_Desafios'
}
...
rename_map_sup = {
    ...
    '1.2 - Há quantos anos você atua em cargos de gestão ou supervisão nesta escola?\xa0 ': 'S1.2_Tempo_Gestao',
    '1.3 - Sua rotina de trabalho envolve ou envolveu o uso de outras plataformas ou sistemas de gestão em outras instituições?\xa0 ': 'S1.3_Outras_Plataformas',
    # Seção 2: Supervisão
    '2.1 - Era fácil ter uma visão geral e centralizada do status dos planejamentos de todos os professores.\xa0 \xa0[Manual]': 'S2.1_Visao_Geral_Manual',
    '2.1 - Era fácil ter uma visão geral e centralizada do status dos planejamentos de todos os professores.\xa0 \xa0[Planilha]': 'S2.1_Visao_Geral_Planilha',
    '2.1 - Era fácil ter uma visão geral e centralizada do status dos planejamentos de todos os professores.\xa0 \xa0[PlanningApp]': 'S2.1_Visao_Geral_PlanningApp',
    '2.2 - O processo de fornecer feedback (avaliacão) aos professores era ágil e bem documentado.\xa0 \xa0[Manual]': 'S2.2_Feedback_Agil_Manual',
    '2.2 - O processo de fornecer feedback (avaliacão) aos professores era ágil e bem documentado.\xa0 \xa0[Planilha]': 'S2.2_Feedback_Agil_Planilha',
    '2.2 - O processo de fornecer feedback (avaliacão) aos professores era ágil e bem documentado.\xa0 \xa0[PlanningApp]': 'S2.2_Feedback_Agil_PlanningApp',
    '2.3 - Identificar planejamentos pendentes ou que precisavam de revisão era uma tarefa rápida.\xa0 \xa0[Manual]': 'S2.3_Identifica_Pendentes_Manual',
    '2.3 - Identificar planejamentos pendentes ou que precisavam de revisão era uma tarefa rápida.\xa0 \xa0[Planilha]': 'S2.3_Identifica_Pendentes_Planilha',
    '2.3 - Identificar planejamentos pendentes ou que precisavam de revisão era uma tarefa rápida.\xa0 \xa0[PlanningApp]': 'S2.3_Identifica_Pendentes_PlanningApp',
    ...
    '2.5 - O tempo gasto em tarefas operacionais de supervisão (procurar arquivos, controlar versões) era baixo.\xa0 \xa0[Manual]': 'S2.5_Tempo_Operacional_Manual',
    '2.5 - O tempo gasto em tarefas operacionais de supervisão (procurar arquivos, controlar versões) era baixo.\xa0 \xa0[Planilha]': 'S2.5_Tempo_Operacional_Planilha',
    '2.5 - O tempo gasto em tarefas operacionais de supervisão (procurar arquivos, controlar versões) era baixo.\xa0 \xa0[PlanningApp]': 'S2.5_Tempo_Operacional_PlanningApp',
    # Seção 3: Usabilidade
    '3.1 - O método era fácil de aprender e usar.\xa0 \xa0[Manual]': 'S3.1_Facil_Aprender_Manual',
    '3.1 - O método era fácil de aprender e usar.\xa0 \xa0[Planilha]': 'S3.1_Facil_Aprender_Planilha',
    '3.1 - O método era fácil de aprender e usar.\xa0 \xa0[PlanningApp]': 'S3.1_Facil_Aprender_PlanningApp',
    # ... (Continue mapping ALL supervisor questions from section 3 to 7) ...
     '7.5 - Você tem alguma sugestão de melhoria para o módulo de supervisão/administração do sistema de planejamento? (Ex: novos relatórios, dashboards, notificações, etc.).\xa0 ': 'S7.5_Sugestao_Melhoria_Sup'
